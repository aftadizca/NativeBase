...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#007aff' : 'transparent',
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : 'transparent',
  ...
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : 'transparent',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : 'transparent',
  ...
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#a7a6ab' : 'transparent',
  get statusBarColor() {
  ...
  listNoteSize: 13,
  listItemSelected: platform === PLATFORM.IOS ? '#007aff' : 'transparent',
  ...
  radioSelectedColorAndroid: 'transparent',
  ...
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : 'transparent',
  segmentBorderColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentBorderColorMain: platform === PLATFORM.IOS ? '#a7a6ab' : 'transparent',
  ...
  // Tab
  tabDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : 'transparent',
